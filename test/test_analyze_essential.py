...
def test_iboot_v20457_v53_54aaf19():
    with open_corpus_binary("iBoot-20457.2.37-v53-54aaf19") as f:
        layout = analyze(BinaryIODriver(f))

        assert layout.text == Region(0x1FC08C000, 0x1FC3F8440, 0)
        assert layout.const == Region(0x1FC3F8440, 0x1FC404000, 0x36C440)
        assert layout.data == Region(0x1FC404000, 0x1FC49A0C0, 0x378000)
        assert layout.bss == Region(0x1FC49A0C0, 0x1FC4C1DD0)
